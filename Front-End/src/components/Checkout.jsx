  ...
  if (productError) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="p-4 rounded-lg bg-red-50 text-red-700">Error: {productError}</div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="backdrop-blur-md bg-white/30 rounded-2xl shadow-[8px_8px_16px_#d0ccbf,-8px_-8px_16px_#ffffff] p-8">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-light tracking-wide">Shipping Details</h2>
            </div>
                ...
                {userData.alternativeNumbers.map((num, index) => (
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setUserData({ ...userData, alternativeNumbers: updatedNumbers });
                    }}
                    className="w-full px-4 py-3 bg-white/50 rounded-lg text-[#8B7355] placeholder-[#8B7355]/60 focus:outline-none shadow-[inset_4px_4px_8px_#d0ccbf,inset_-4px_-4px_8px_#ffffff]"
          ...
          <div className="space-y-6">
            ...
            <div className="backdrop-blur-md bg-white/30 rounded-2xl shadow-[8px_8px_16px_#d0ccbf,-8px_-8px_16px_#ffffff] p-8">
              ...
              <div className="space-y-6">
                {cartItems.map((item, index) => (
                  <div key={index} className="flex items-center space-x-4 p-4 bg-white/50 rounded-lg shadow-[inset_4px_4px_8px_#d0ccbf,inset_-4px_-4px_8px_#ffffff]">
                    <img
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#8B7355]/70">Quantity: {item.quantity}</p>
                      <p className="text-lg font-medium">₹{item.product.price * item.quantity}</p>
                    </div>
                  </div>
                ))}
            ...
            <div className="backdrop-blur-md bg-white/30 rounded-2xl shadow-[8px_8px_16px_#d0ccbf,-8px_-8px_16px_#ffffff] p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-light tracking-wide">Payment Method</h2>
              </div>
            ...
            <button
              ...
              disabled={isSubmitting || !userData.address.street || !userData.address.city || !userData.address.state || !userData.address.zipCode || !userData.address.country}
