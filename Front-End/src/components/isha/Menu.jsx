...
const Menu = () => {
  return (
    <div className="bg-[#0d0c09] text-[#d4c19f] font-serif flex justify-center items-center min-h-screen px-4">
      <div className="flex flex-col lg:flex-row justify-center items-center lg:w-4/5 gap-8">
        ...
        <div className="w-full lg:w-1/3 text-center my-5 lg:my-0">
          ...
          <h1 className="text-xl lg:text-3xl mb-5 font-bold">Today's Special</h1>
          ...
          <button className="mt-5 px-4 py-2 bg-[#d4c19f] text-gray-900 rounded-md text-sm lg:text-lg hover:bg-[#bba57e]">
            View More
          </button>
        </div>
